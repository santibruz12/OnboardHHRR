...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const toggleSidebar = React.useCallback(() => {
    ...
    return isMobileDetected ? setOpenMobile((open) => !open) : setOpen((open) => !open)
  ...
  const contextValue = React.useMemo<SidebarContext>(
    () => ({
      ...
      open,
      setOpen,
      isMobile: false, // We'll handle mobile detection elsewhere
      openMobile,
      setOpenMobile,
      toggleSidebar,
    }),
    ...
    >
      ...
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+theme(spacing.4)+theme(spacing.2))]"
